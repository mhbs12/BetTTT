...
export function createBetTransaction(coinObjectId: string, amount: string): Transaction {
  ...
  // Pass the entire coin object to Move function, let it handle splitting internally
  tx.moveCall({
...
export function joinBetTransaction(treasuryId: string, coinObjectId: string, amount: string): Transaction {
  ...
  // Pass treasury, entire coin object, and amount to Move function
  // Let the Move function handle splitting internally
  tx.moveCall({
